...
import com.uce.p4.repository.IDetalleVentaRepo;
import com.uce.p4.repository.IProductoRepo;
import com.uce.p4.repository.IVentaRepo;
...
public class GestorServiceImpl implements IGestorService {
    ...
    public List<ReporteVentas> generarReporte(LocalDateTime fechaVenta, String categoria, Integer cantidad) {
        return this.detalleVentaRepo.buscarReporte(fechaVenta, categoria, cantidad);
